...
func main() {
	...
	strategyService := services.NewStrategyService(stockService)
	...
	api := r.Group("/api")
	{
		...
		{
			strategy.GET("/list", strategyHandler.List)
			strategy.GET("/get/:id", strategyHandler.Get)
			strategy.POST("/create", strategyHandler.Create)
			strategy.POST("/update/:id", strategyHandler.Update)
			strategy.POST("/delete/:id", strategyHandler.Delete)
			strategy.POST("/set-default/:id", strategyHandler.SetDefault)
			strategy.POST("/copy/:id", strategyHandler.Copy)
			strategy.GET("/default", strategyHandler.GetDefault)
			strategy.POST("/evaluate", strategyHandler.Evaluate)
			strategy.GET("/indicators", strategyHandler.GetIndicatorLib)
		}
	...
	r.GET("/sw.js", func(c *gin.Context) { c.File("./static/sw.js") })
